...
public class EWRecipeProvider extends VanillaRecipeProvider {
    ...
    public EWRecipeProvider(PackOutput arg) {
        super(arg);
    }
    ...
    private static void smithingUpgrade(Consumer<FinishedRecipe> out, Item base, Block addition, Item result, RecipeCategory cat, String name) {
