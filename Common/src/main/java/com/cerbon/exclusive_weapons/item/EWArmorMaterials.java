...
public enum EWArmorMaterials implements StringRepresentable, ArmorMaterial {
    ...
    }), (int) addBoost(9), SoundEvents.ARMOR_EQUIP_IRON, 0.0F, 0.0F, () -> Ingredient.of(Items.IRON_INGOT)),
    ...
    SUPER_GOLD("super_gold", (int) addBoost(7), Util.make(new EnumMap<>(ArmorItem.Type.class), enumMap -> {
        ...
        enumMap.put(ArmorItem.Type.HELMET, (int) addBoost(2));
    }), (int) addBoost(25), SoundEvents.ARMOR_EQUIP_GOLD, 0.0F, 0.0F, () -> Ingredient.of(Items.GOLD_INGOT)),
    ...
    }), (int) addBoost(10), SoundEvents.ARMOR_EQUIP_DIAMOND, addBoost(2.0F), 0.0F, () -> Ingredient.of(Items.DIAMOND)),
    ...
    SUPER_NETHERITE("super_netherite", (int) addBoost(37), Util.make(new EnumMap<>(ArmorItem.Type.class), enumMap -> {
        ...
        enumMap.put(ArmorItem.Type.CHESTPLATE, (int) addBoost(8));
        enumMap.put(ArmorItem.Type.HELMET, (int) addBoost(3));
    }), (int) addBoost(15), SoundEvents.ARMOR_EQUIP_NETHERITE, addBoost(3.0F), addBoost(0.1F), () -> Ingredient.of(Items.NETHERITE_INGOT));
    ...
    EWArmorMaterials(String name, int durabilityMultiplier, EnumMap<ArmorItem.Type, Integer> protectionFunctionForType, int enchantmentValue, SoundEvent sound, float toughness, float knockbackResistance, Supplier<Ingredient> repairIngredient) {
        this.name = name;
